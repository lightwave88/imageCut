(function (global) {
    ...
    (function () {
        ...
        this._getDoms = function () {
            ...
            let imageDom = this.image_data.dom = this.root_data.dom.querySelector('.ct_imageBackbroud');
            //----------------------------
            ...
            // this.doms['cutArea'] = imageDom.querySelector('div.cut_area');
        };
        //======================================================================
        ...
        this._basicCssSetting = function () {
            ...
            // image容器的(大小, 偏移位置)設定
            let cssSetting_1 = {
                'margin-left': (-1 * (this.image_data.width * 0.5)),
                'margin-top': (-1 * (this.image_data.height * 0.5)),
        ...
        this._checkGeometry = function () {
            ...
            console.log('operateArea_data(%s)', JSON.stringify(this.operateArea_data));
            //----------------------------
        ...
        //======================================================================
        this._isNearChooseArea = function (h, v) {
            let fixPoint = this._isNearChooseArea_fixPoint;
            if (Math.abs(h - this.chooseArea.left) < fixPoint || Math.abs(h - this.chooseArea.right) < fixPoint) {
                if (v > (this.chooseArea.top - fixPoint) && v < (this.chooseArea.bottom + fixPoint)) {
                    return true;
                }
            } else if (Math.abs(v - this.chooseArea.top) < fixPoint || Math.abs(v - this.chooseArea.bottom) < fixPoint) {
                if (h > (this.chooseArea.left - fixPoint) && h < (this.chooseArea.right + fixPoint)) {
                    return true;
                }
            }
    ...
    (function () {
        ...
        //==========================================================================
        // 更新 ChooseArea
        this._updateChooseAreaSizeBySelectArea = function (left, top) {
        ...
        this._getChooseArea = function () {
            ...
            // chooseArea.set
            this.chooseArea.left = this.image_data.dom.offsetLeft;
            this.chooseArea.top = this.image_data.dom.offsetTop;
            ...
            console.log('choose: %s', JSON.stringify(this.chooseArea));
        };
        //======================================================================
    ...
    (function () {
        this._check_1 = function () {
            ...
            if (!this.image_data.dom) {
                error.push('no set dom.ct_imageBackbroud');
            }
        ...
        this._updateBySelectArea = function (e) {
            ...
            //----------------------------
            this._updateChooseAreaSizeBySelectArea(left, top);
